  ...
  nodes: [
    {
      ...
      dataDomainName: '商家',
      description:
        '提供外卖或配送服务的主体，包含门店相关入驻、配送协议，操作记录及其他品牌、品类等基础信息',
      tableCnt: 140,
      hierarchy: 0,
      bizProcessGraph: {
        nodeList: [
    ...
    },
    {
      ...
      lobId: 27,
      dataDomainName: '数仓管理',
      description: '和数据管理(元数据、任务统计、模型质量评估等)相关的数据',
      tableCnt: 2,
      hierarchy: 0,
      bizProcessGraph: {
        nodeList: [
    ...
    },
    {
      ...
      dataDomainName: '结算',
      description:
        '对业务收支往来的情况进行清分记账，生成凭证等处理过程及账务主体的数据',
      tableCnt: 205,
      hierarchy: 0,
      bizProcessGraph: {
        nodeList: [
    ...
    },
    {
      ...
      dataDomainName: '履约',
      description:
        '主要负责线下配送服务履约过程的时效、规模、完成率三个方面的数据',
      tableCnt: 41,
      hierarchy: 0,
      bizProcessGraph: {
        nodeList: [
