...
// const VueLoader3 = path.join(__dirname, '../node_modules/vue-loader3')
const VueLoader2 = path.join(__dirname, '../node_modules/vue-loader2')
const DefaultVueLoader = path.join(__dirname, '../node_modules/vue-loader')
...
function useVueLoaderVersion(version) {
  if (version === 2 && fs.existsSync(VueLoader2)) {
    rename(VueLoader2, DefaultVueLoader)
  } else {
    rename(VueLoader3, DefaultVueLoader)
